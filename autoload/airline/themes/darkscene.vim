...
" flat colors:
let s:asphalt = { "gui": "#100E23", "cterm": "233", "cterm16": "NONE"}
let s:asphalt_subtle= { "gui": "#090913", "cterm": "232", "cterm16": "8"}
...
let g:airline#themes#darkscene#palette = {}
...
let g:airline#themes#darkscene#palette.normal = airline#themes#generate_color_map(s:N1, s:N2, s:N3)

let g:airline#themes#darkscene#palette.normal_modified = {
...
let g:airline#themes#darkscene#palette.insert = airline#themes#generate_color_map(s:I1, s:I2, s:I3)
let g:airline#themes#darkscene#palette.insert_modified = {
      \ 'airline_c': [ s:white.gui , s:bg_subtle.gui , s:white.cterm16, s:bg_subtle.cterm16      , ''     ] ,
      \ }
let g:airline#themes#darkscene#palette.insert_paste = {
      \ 'airline_a': [ s:I1[0]   , s:yellow.gui , s:I1[2] , s:yellow.cterm16     , ''     ] ,
      \ }


let g:airline#themes#darkscene#palette.replace = copy(g:airline#themes#darkscene#palette.insert)
let g:airline#themes#darkscene#palette.replace.airline_a = [ s:I2[0]   , s:yellow.gui , s:I2[2] , s:yellow.cterm16     , ''     ]
let g:airline#themes#darkscene#palette.replace_modified = g:airline#themes#darkscene#palette.insert_modified
...
let g:airline#themes#darkscene#palette.visual = airline#themes#generate_color_map(s:V1, s:V2, s:V3)
let g:airline#themes#darkscene#palette.visual_modified = {
...
let g:airline#themes#darkscene#palette.inactive = airline#themes#generate_color_map(s:IA1, s:IA2, s:IA3)
let g:airline#themes#darkscene#palette.inactive_modified = {
      \ 'airline_c': [ s:IA3[0] , s:IA3[1] , s:IA3[2] , s:IA3[3], ''     ] ,
      \ }


let s:WI = [ s:yellow.gui, s:dark_red.gui, s:yellow.cterm16, s:dark_red.cterm16 ]
let g:airline#themes#darkscene#palette.normal.airline_warning = [
     \ s:WI[0], s:WI[1], s:WI[2], s:WI[3]
     \ ]

let g:airline#themes#darkscene#palette.normal_modified.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning

let g:airline#themes#darkscene#palette.insert.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning

let g:airline#themes#darkscene#palette.insert_modified.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning

let g:airline#themes#darkscene#palette.visual.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning

let g:airline#themes#darkscene#palette.visual_modified.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning

let g:airline#themes#darkscene#palette.replace.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning

let g:airline#themes#darkscene#palette.replace_modified.airline_warning =
    \ g:airline#themes#darkscene#palette.normal.airline_warning
