...
" Name:       darkscene.vim
" Version:    1.0
" Maintainer: github.com/aswathkk
" License:    The MIT License (MIT)
" Based On: Challenger Deep by github.com/maxst
...
let g:colors_name='darkscene'
set background=dark

if ! exists("g:darkscene_termcolors")
  let g:darkscene_termcolors = 256
endif

" not all terminals support italics properly.  If yours does, opt-in.
if ! exists("g:darkscene_terminal_italics")
  let g:darkscene_terminal_italics = 0
endif
...
let s:asphalt_subtle = { "gui": "#0C0B1A", "cterm": "232", "cterm16": "0"}
...
function! s:h(group, style)
  " Not all terminals support italics properly. If yours does, opt-in.
  if g:darkscene_terminal_italics == 0 && has_key(a:style, "cterm") && a:style["cterm"] == "italic"
    unlet a:style.cterm
  endif
  if g:darkscene_termcolors == 16
...
call s:h("Error",         {"fg": s:dark_red, "gui": "bold", "cterm": "bold"})
call s:h("Todo",          {"fg": s:dark_yellow, "gui": "bold", "cterm": "bold"})
